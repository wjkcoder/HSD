                ...
                $("#jsGrid-basic").jsGrid({
                    ...
                    controller: {
                        loadData: function (filter) {
                            return $.ajax({
                                type: "GET",
                                url: "http://localhost/hsd/public/Index.php/index/SysCtrAction/rwQuery",
                                dataType: "json"
                            });
                        },
                        ...
                        updateItem: function (item) {
                            return $.ajax({
                                type: "POST",
                                url: "http://localhost/hsd/public/Index.php/index/SysCtrAction/rwUpdate",
                                data: {data: item},
                                dataType: "text",
                                success: function (data) {
                                    if (data == 'y') {
                    ...
                    fields: [
                        {name: "ctr_series_block_id", title: "控制器字段ID", type: "text", visible: false},
                        {
                            name: "ctr_series_id",
                            title: "字段编码",
                            type: "select",
                        ...
                        {name: "block_code", type: "text", title: "字段描述", validate: "required"},
                        {name: "block_des", type: "text", title: "字段描述", validate: "required"},
                        {
                            name: "enable_flag",
                            type: "select",
                            title: "enable_flag",
